...
function Common() {
    ...
    function login() {
        ...
        if (accessTokenExists) {
            ...
            loginHTML = `<span class="top-bar-header-avatar"><span class="top-bar-header-avatar-box"><a href="http://github.com/${USERNAME}"><img src="${HEADER_AVATAR}"alt="HEADER-AVATAR"style="width: 30px; height: 30px; border-radius: 50%; margin-top: 0px"></a></span></span><span class="top-bar-username"><span class="top-bar-username-box"><a href="http://github.com/${USERNAME}"style="text-decoration: none; text-align: center; transition: background-color 0.3s ease; display: inline-block; margin-right: 0px;">@${USERNAME}</a></span></span><span class="top-bar-header-avatar"><span class="top-bar-header-avatar-box"><a href=""><div class="button-div"><a href="/manager/upload/index.html"class="button"style="background-color: #00b3ff; border-radius: 20px; padding: 4px 18px; text-decoration: none; color: white; text-align: center; transition: background-color 0.3s ease; display: inline-block; margin-top: 0px; margin-left: 0px; margin-right: 18px;">投稿</a></div></a></span></span><span class="top-bar-user-login-out"><span class="top-bar-login-out"><a href="/loginout.html">注销</a></span></span>`;
